...
// タスクの取得
require(__DIR__.'/api/task/get-task.php');
$tasks = getTask($checkLogin['pdo'], $_SESSION['userId'], 2);
$_SESSION['back_url'] = "{$public_url}done.php";
?>
<!DOCTYPE html>
<html lang="ja">
<head>
  ...
  <div id="content">
    <div id="main-content">
      <div class="check-list">
        <a href="./logined.php">全て</a>　-　<a href="./doing.php">未完了</a>　-　完了済み
      </div>
      <div class="table">
