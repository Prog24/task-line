...
$_SESSION['back_url'] = "{$public_url}doing.php";
?>
...
// タスクの取得
require_once(__DIR__.'/api/task/get-task.php');
$tasks = getTask($checkLogin['pdo'], $_SESSION['userId'], 1);
?>
<!DOCTYPE html>
<html lang="ja">
<head>
  ...
  <div id="content">
    <div id="main-content">
      <div class="check-list">
        <a href="./logined.php">全て</a>　-　未完了　-　<a href="./done.php">完了済み</a>
      </div>
      <div class="table">
